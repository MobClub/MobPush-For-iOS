//
//  MobPushLiveActivitiesLiveActivity.swift
...
struct MobPushLiveActivitiesLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: MobPushLiveActivitiesAttributes.self) { context in
            // 在锁屏页 或者 通知列表页中展示。
            lockView(context)
    ...
    @ViewBuilder
    func lockView(_ context: (ActivityViewContext<MobPushLiveActivitiesAttributes>)) -> some View {
        VStack {
            HStack {
                HStack {
                    MyViews.CirclrIcon("person.and.background.dotted", color: .blue)
